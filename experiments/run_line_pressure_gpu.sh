...
#   sbatch experiments/run_line_pressure_gpu.sh
#
# Pick a GPU by uncommenting exactly one block below.
# =============================================================================
...
# RTX 4000 Ada — instruction partition
...
PROJECT_DIR="${PROJECT_DIR:-$HOME/repo759/PROJECT}"
SCRIPT="$PROJECT_DIR/gpu_standard_example/gpu_plate_membrane_line_pressure.jl"
